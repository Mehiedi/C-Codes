...
int main()
{
    ...
    //done
    printf("[Welcome to XeNon Automobiles Ltd.]\n");
    ...
    if(start==1)
    {
        ...
        printf("\nDear %s, welcome to XeNon Automobiles Ltd.!!!",user_name);
...
void details_of_booking_ticket_khulna()
{
    ...
    if(coach_for_Khulna==1)
    {
        ...
        printf("\nBus Number: Dhaka Metro-HA,32-37-81");
        printf("\nSupervisor Name : AL AHAD ARMAN");
        printf("\nSupervisor Phone Number : 0187494060\n");
    }
    ...
    else if(coach_for_Khulna==2)
    {
        ...
        printf("\nBus Number: Dhaka Metro-LA,42-47-91");
        printf("\nSupervisor Name : Al AHAD ARMAN");
        printf("\nSupervisor Phone Number : 016264236219\n");
    }
    ...
    else if(coach_for_Khulna==3)
    {
        ...
        printf("\nBus Number: Dhaka Metro-HA,52-57-71");
        printf("\nSupervisor Name : MONIKA RAHMAN ");
        printf("\nSupervisor Phone Number : 01874940460\n");
    }
    ...
    else
    {
        ...
        printf("\nBus Number: Dhaka Metro-HA,55-55-55");
        printf("\nSupervisor Name : MONIKA RAHMAN");
        printf("\nSupervisor Phone Number : 01626423619\n");
    }
}
...
void details_of_booking_ticket_khulna_back()
{
    ...
    if(coach_for_Khulna==1)
    {
        ...
        printf("\nBus Number: Dhaka Metro-HA,32-37-81");
        printf("\nSupervisor Name : AKRAMUL ISLAM EMON");
        printf("\nSupervisor Phone Number : 01715522583\n");
    }
    ...
    else if(coach_for_Khulna==2)
    {
        ...
        printf("\nBus Number: Dhaka Metro-LA,42-47-91");
        printf("\nSupervisor Name : MAHUDUL ISLAM PRANTO");
        printf("\nSupervisor Phone Number : 01764893027\n");
    }
    ...
    else if(coach_for_Khulna==3)
    {
        ...
        printf("\nBus Number: Dhaka Metro-HA,52-57-71");
        printf("\nSupervisor Name : ANIKA JAHAN MOHONA");
        printf("\nSupervisor Phone Number : 01654897546\n");
    }
    ...
    else
    {
        ...
        printf("\nDeparture Time : 11:00 am");
        printf("\nBus Number: Dhaka Metro-HA,55-55-55");
        printf("\nSupervisor Name : ASHIK UR RAHMAN JEWEL ");
        printf("\nSupervisor Phone Number : 01646798765\n");
    }
}
...
void details_of_booking_ticket_Rajshahi()
{
    ...
    if(coach_for_Rajshahi==1)
    {
        ...
        printf("\nDeparture Time : 7:00 am");
        printf("\nBus Number: Dhaka Metro-HA,22-27-51");
        printf("\nSupervisor Name : ABDUL QAIUM JHONY");
        printf("\nSupervisor Phone Number : 019854623725\n");
    }
    ...
    else if(coach_for_Rajshahi==2)
    {
        ...
        printf("\nDeparture Time : 12:00 pm");
        printf("\nBus Number: Dhaka Metro-LA,82-89-91");
        printf("\nSupervisor Name : AINUR AKTHER URMI");
        printf("\nSupervisor Phone Number : 018756498064\n");
    }
    ...
    else
    {
        ...
        printf("\nDeparture Time : 11:00 am");
        printf("\nBus Number: Dhaka Metro-HA,57-75-55");
        printf("\nSupervisor Name : ABDULLA AL AHAD ");
        printf("\nSupervisor Phone Number : 01874940460\n");
    }
}
...
void details_of_booking_ticket_Rajshahi_back()
{
    ...
    if(coach_for_Rajshahi==1)
    {
        ...
        printf("\nDeparture Time : 7:00 am");
        printf("\nBus Number: Dhaka Metro-HA,22-27-51");
        printf("\nSupervisor Name : SHAHINUR AKTER ONNI");
        printf("\nSupervisor Phone Number : 01646738764\n");
    }
    ...
    else if(coach_for_Rajshahi==3)
    {
        ...
        printf("\nDeparture Time : 6:00 pm");
        printf("\nBus Number: Dhaka Metro-HA,42-57-42");
        printf("\nSupervisor Name : ABDULLA AHAD ARMAN\n");
        printf("\nSupervisor Phone Number : 01874940460\n");
        }
               ...
               else
        {
            ...
            printf("\nBus Number: Dhaka Metro-HA,57-75-55");
            printf("\nSupervisor Name : MONIKA RAHMAN");
            printf("\nSupervisor Phone Number : 01646756432\n");
        }
    }
...
//FUNCTION FOR DHAKA TO COMILLA ROUTE:
    void details_of_booking_ticket_Comilla()
    {
        ...
        else if(coach_for_Comilla==2)
        {
            ...
            printf("\nBus Number: Dhaka Metro-LA,82-88-91");
            printf("\nSupervisor Name : MONIKA RAHMAN");
            printf("\nSupervisor Phone Number : 01646731821\n");
